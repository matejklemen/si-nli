...
source_file = "tgt-small.txt"
target_file = "tgt-small.txt"
...
source_sentences = list(source_sentences)[:10000]


print("Encode source sentences")
source_embeddings = model.encode(source_sentences, show_progress_bar=True, convert_to_numpy=True, batch_size=512)


### Encode target sentences
target_sentences = list(target_sentences)[:10000]

print("Encode target sentences")
target_embeddings = model.encode(target_sentences, show_progress_bar=True, convert_to_numpy=True, batch_size=512)
