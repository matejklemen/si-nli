...
class TransformersNLITrainer:
    def __init__(self, model_dir, pretrained_model_name_or_path, num_labels,
                 batch_size=24, learning_rate=6.25e-5, validate_every_n_steps=5_000,
                 early_stopping_tol=5, use_mcd: Optional[bool] = False, class_weights: Optional = None,
